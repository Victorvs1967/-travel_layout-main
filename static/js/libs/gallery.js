...
class Gallery {
  constructor(e, t = {}) {
    ...
    this.settings = { margin: t.margin || 0 };
  ...
  clickDots(e) {
    ...
    if (s) {
      ...
      t !== this.currentSlide &&
        ((e = Math.abs(this.currentSlide - t)),
        (this.currentSlide = t),
  ...
  moveToLeft() {
    this.currentSlide <= 0 ||
      ((this.currentSlide = this.currentSlide - 1), this.changeCurrentSlide());
  }
  moveToRight() {
    this.currentSlide >= this.size - 1 ||
      ((this.currentSlide = this.currentSlide + 1), this.changeCurrentSlide());
  ...
  setStyleTransition(e = 1) {
    this.lineNode.style.transition = `all ${0.25 * e}s ease 0s`;
  }
...
function debounce(t, s = 100) {
  let i;
  return function (e) {
    clearTimeout(i), (i = setTimeout(t, s, e));
  };
}
